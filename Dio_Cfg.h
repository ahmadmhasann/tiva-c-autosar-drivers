...
#define DIO_DEV_ERROR_DETECT                (STD_ON) /* Pre-compile option for Development Error Detect         */
#define DIO_VERSION_INFO_API                (STD_ON) /* Pre-compile option for Version Info API                 */
#define DIO_FLIP_CHANNEL_API                (STD_ON) /* Pre-compile option for presence of Dio_FlipChannel API  */
#define DIO_CONFIGURED_CHANNLES             (4U)     /* Number of the configured Dio Channels                   */
